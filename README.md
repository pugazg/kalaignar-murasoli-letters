...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **canonical migration 1–126 / 401; second Volume 1 ten-letter batch complete** | **26 / 110 complete; 0001–0026; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical migration/alignment pending** |
