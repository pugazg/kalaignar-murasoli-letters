...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **canonical migration 1–160 / 401; third Volume 1 ten-letter batch complete** | **36 / 110 complete; 0001–0036; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical migration/alignment pending** |
