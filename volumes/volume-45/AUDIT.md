...
- Genuine source-context differences retained pending their later start-page checks: 3575 contents `...!` vs first-pass start `....!`; 3576 contents `பாரீர்!` vs first-pass start `பார்!`.
