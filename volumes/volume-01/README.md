...
- Canonical PDF coverage: **001–235 / 401**.
...
- Canonically complete letters: **0001–0056 (56 / 110)**.
...
- Batch-specific source anomalies and legacy divergences are recorded in [`AUDIT.md`](AUDIT.md), including the PDF 211 `ஆட்டுச்சந்தைக்கு அருகாமையில்!` scan/legacy divergence and the unusual PDF 228 joined numeral wording.
- PDF 236 visibly begins letter 0057 — `“பிறந்த நாள் வேண்டுகோள்!”` — and was inspected only to verify the next boundary; no letter 0057 text is committed in this batch.
...
Begin at **PDF 236**, where the scan visibly starts letter **0057 — `“பிறந்த நாள் வேண்டுகோள்!”`**. In the next regular Volume 1 iteration, migrate exactly **10 complete consecutive letters — 0057 through 0066** — with direct scan verification of every page and boundary. Stop before any text from letter 0067. Keep the legacy bilingual corpus untouched and do not begin English migration yet.
