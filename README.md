...
| 41 | 25.11.2007–21.01.2009 | 402 | **PDF 001–025 / 402 first-pass; contents 58 / 58; Letter 3306 partial** | **0 / 58 complete; 3306 partial** | **BLOCKED pending Tamil archival gates** |
...
Volume 43 source intake is established from `TVA_BOK_0065828_கலைஞரின்_கடிதங்கள்_தொகுதி_43.pdf`.
...
- Second-pass Batch 5 directly verified **3379–3383 / PDF 106–149** and corrected PDF **109, 111, 112, 116, 118, 119, 120, 122, 124, 126, 127, 128, 129, 132, 143, 144, 145, 146 and 147**; **28 scan-proven corrections** were applied with no title/date/boundary/contents-row change.
- Second-pass Batch 6 directly verified **3384–3388 / PDF 150–190** and changed PDF **151, 154, 157, 158, 162, 167, 179, 184, 187 and 188**; **17 scan-proven textual corrections plus 1 physical page-boundary restoration** were applied. The actual PDF 187 main-title/subtitle split for Letter 3388 remains preserved.
...
- Bilingual meaning-level alignment is **COMPLETE — 56 / 56**. English editorial consistency review is **PASS — 56 / 56**, with **2 English-only consistency corrections and 0 canonical Tamil changes**. Final English release verification is **PASS — 56 / 56; FINAL RELEASE COMPLETE**.
...
- Batch 8 preserves Letter **3467** as a facsimile-bearing record without guessed handwriting transcription, all source-supplied Supreme Court English in **3468**, the `Udanpirappu`/cover rhetoric in **3469**, and the source-supplied Macmillan English in **3470**.
...
- Final release report: [Volume 43 English release](volumes/volume-43/translations/en/RELEASE_REPORT.md) — **PASS — 56 / 56**. No further Volume 43 English QA/release gate remains pending.
...
- [English index](volumes/volume-45/translations/en/README.md)
- [Translation manifest](volumes/volume-45/translations/en/TRANSLATION_MANIFEST.csv)
- [Final release report](volumes/volume-45/translations/en/RELEASE_REPORT.md)
...
- PDF 001–004 are local Volume 41 front matter; PDF 004 preserves **அம்மாவுக்கு...**.
- PDF 005–017 directly match the approved Volume 43 shared-front-matter source text and use shared references.
- Printed contents PDF **018–022**: **58 / 58 rows transcribed — 3306–3363**.
- PDF 023: blank / reverse show-through.
- Letter **3306** begins PDF **024 / printed 23** and is transcribed through PDF **025 / printed 24**; status **partial**.
- Intake reconnaissance places the close of 3306 at PDF **033 / printed 32**; Letter **3307** begins PDF **034 / printed 33**.
- English remains **BLOCKED**.
- Exact next activity: **complete Letter 3306 across PDF 026–033**, then stop before 3307.
...
- Final English release verification: **PASS / COMPLETE — 64 / 64**.
- Release manifest: **64 rows / 64 unique source-record numbers / 64 unique English paths / 0 source-incomplete**.
- Release-verification English body corrections: **0**; Tamil changes: **0**.
