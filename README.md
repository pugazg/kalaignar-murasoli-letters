...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **canonical migration 1–199 / 401; fourth Volume 1 ten-letter batch complete** | **46 / 110 complete; 0001–0046; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical migration/alignment pending** |
