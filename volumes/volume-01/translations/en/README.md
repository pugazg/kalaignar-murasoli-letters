...
Status: **ACTIVE — canonical English migration/source checking in progress.**
...
Canonical migration/source check is complete for letters **0001–0100 (100 / 110)**. These records are `source-checked`, not yet `verified`; bilingual alignment remains a separate gate.
...
Exact next batch: **0101–0110** — the final Volume 1 source-check batch.
