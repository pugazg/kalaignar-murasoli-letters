...
- Canonical PDF coverage: **001–199 / 401**.
...
- Canonically complete letters: **0001–0046 (46 / 110)**.
...
- Batch-specific source anomalies and legacy divergences are recorded in [`AUDIT.md`](AUDIT.md), including scan-visible passages absent from legacy reading copies on PDFs 099, 144 and 164.
- PDF 200 visibly begins letter 0047 — `“தாயே எட்டடி என்றால்...”` — and was inspected only to verify the next boundary; no letter 0047 text is committed in this batch.
...
Begin at **PDF 200**, where the scan visibly starts letter **0047 — `“தாயே எட்டடி என்றால்...”`**. In the next regular Volume 1 iteration, migrate exactly **10 complete consecutive letters — 0047 through 0056** — with direct scan verification of every page and boundary. Stop before any text from letter 0057. Keep the legacy bilingual corpus untouched and do not begin English migration yet.
