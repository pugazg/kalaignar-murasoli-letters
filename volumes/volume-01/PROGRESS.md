...
- [ ] Second visual/textual-fidelity verification — **in progress; PDF 001–150 / 401 complete**
...
- Cumulative second-pass corrections: **73 canonical pages / 160 spans**
- PDF 126–150 required scan-proven corrections on **15 canonical pages / 32 spans**
- This range chiefly restores source-bold opening addresses, quoted newspaper/political passages, the eight-line accusation display on PDF 136, selected Hande-letter emphasis on PDFs 138–140, and source emphasis through PDFs 146–148
- PDFs **126, 128, 131, 137, 139, 142, 144, 145, 149 and 150** required no canonical correction
- Letters **0001–0033** now have complete second-pass source-page coverage; letter **0034** is checked through PDF 150 and continues beyond the current range
