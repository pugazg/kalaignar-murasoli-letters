...
- [ ] Relevant Tamil pages must pass the mandatory scan-to-canonical textual-fidelity / second visual review required by `VOLUME_PROCESSING_GUIDE.md`.
  ...
  - [ ] PDF **201–402** remains to be second-pass verified.
...
Cumulative scan-based coverage now reaches PDF **200**. Complete source letters **3592–3616** have full second-pass coverage. Across the completed fidelity ranges, **16 pages / 18 spans** have required scan-proven correction: PDF 052, 066, 079, 097, 099, 114, 119, 122, 126, 142, 154, 160, 161, 172, 173 and 179. Letter **3617** is second-pass checked through PDF 200 and continues through PDF 205.
...
Second-pass verify **PDF 201–225**. Complete letter 3617 and continue subsequent source letters, correct only scan-proven defects, and record the next fidelity range. Do not begin English translation in this activity.
