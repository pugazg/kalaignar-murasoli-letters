...
**Fetch live `main` first and treat it as authoritative.** The last confirmed live HEAD immediately before this batch-8 alignment mutation was:

`016da40884795b5748ce886c6ea8bf08d0b24d80` — `Synchronize Volume 44 alignment letters 3514-3518`
...
**Volume 44 Tamil archival preparation is complete through both required full-volume gates. English translation/source-check is complete for all 53 source records. Bilingual alignment is durably synchronized through Letter 3523.**
...
Execute the ninth **five-record bilingual meaning-level alignment batch — Letters 3524–3528 / PDF 291–325**.

1. Reconfirm live `main`; if it has advanced, recompute the actual next durable batch before doing any work.
2. Read the completed alignment reports, the source-check reports relevant to 3524–3528, the current `GLOSSARY.md`, and the Volume 45 alignment precedent.
...
7. Create `volumes/volume-44/translations/en/BILINGUAL_ALIGNMENT_REVIEW_3524_3528.md`.
8. Mark Letters 3524–3528 and their manifest rows `bilingual_alignment_status: aligned`, retaining `translation_status: source-checked`.
9. Update English/Volume/root controls so all counts and next-range statements agree.
10. Stop after **Letter 3528**. **Do not begin 3529, volume-level editorial review or final release verification in the same activity.**
