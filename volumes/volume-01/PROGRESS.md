...
- [ ] Second visual/textual-fidelity verification — **in progress; PDF 001–325 / 401 complete**
...
- Second visual/textual-fidelity verification: **in progress — PDF 001–325 / 401 complete**
- Fidelity reports completed through [`translations/en/TEXTUAL_FIDELITY_AUDIT_301_325.md`](translations/en/TEXTUAL_FIDELITY_AUDIT_301_325.md)
- Cumulative second-pass corrections: **140 canonical pages / 255 spans**
- PDF 301–325 required scan-proven corrections on **9 canonical pages / 9 spans**
- This range restores source-visible bold emphasis on the opening salutations for letters **0082–0090** on PDFs **301, 302, 305, 308, 310, 313, 316, 319 and 322**, preserving the scan's exact joined/spaced forms
- Letters **0001–0090** now have complete second-pass source-page coverage
...
Continue the **second visual/textual-fidelity verification with PDF 326–350**, comparing every canonical Markdown page directly against the controlling scan, applying only scan-proven corrections and recording the next range audit/cumulative status. Keep the legacy bilingual corpus untouched. Do not begin canonical English migration while the required second visual/textual-fidelity gate remains incomplete.
