...
| 45 | 12.03.2011–27.09.2011 | 402 | **1–344 canonical; Tamil transcription in progress** | **46 complete; 3537–3582** | **blocked until Tamil transcription and required QA gates complete** |
...
**Active work — Volume 45:** canonical Tamil is complete through PDF page **344 / printed page 343**, ending with Letter **3582** dated **25-08-2011**. The exact next batch begins at PDF page **345 / printed page 344** with Letter **3583** and covers the next five complete actual source letters **3583–3587**, stopping before any part of Letter 3588. See [Volume 45 README](volumes/volume-45/README.md), [PROGRESS](volumes/volume-45/PROGRESS.md), [AUDIT](volumes/volume-45/AUDIT.md), and [metadata](volumes/volume-45/metadata.yml).
