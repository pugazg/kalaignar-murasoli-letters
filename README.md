...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **1–401 first-pass canonical transcription complete; final residue 0107–0110 complete** | **110 / 110 complete; 0001–0110; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical English migration/alignment pending Tamil audit gates** |
...
தொகுதி 01 canonical migration நிலைக்கு [Volume 01 README](volumes/volume-01/README.md) மற்றும் [legacy migration audit](volumes/volume-1/MIGRATION_AUDIT.md) பார்க்கவும். பழைய `volumes/volume-1/` bilingual/audit material provenance ஆக மாற்றமின்றி பாதுகாக்கப்படுகிறது.
