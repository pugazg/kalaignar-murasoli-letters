...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **canonical migration 1–89 / 401; first Volume 1 ten-letter batch complete** | **16 / 110 complete; 0001–0016; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical migration/alignment pending** |
