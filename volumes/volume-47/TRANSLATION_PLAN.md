...
Letter **3681** is source-incomplete because printed page **252** is absent from the sole source PDF. Only its available audited Tamil has been translated; the missing continuation and closing remain unreconstructed. Its date comes from the printed contents.
...
- Draft-translated: **47** — letters 3647–3693
- Bilingual-aligned: **0**
- English release verified: **0**
- Source-incomplete: **1** — letter 3681

The next exact task is to complete letter **3694** as a one-letter batch, including full audited Tamil embedding and integrity checking.
