...
|---|---|---:|---:|---:|---:|
| 01 | 22.10.1968–01.12.1974 | 401 | **1–401 first-pass canonical transcription complete; full-volume Tamil structural audit PASS; second visual/textual-fidelity verification in progress — PDF 001–050 / 401** | **110 / 110 complete; 0001–0110; printed pagination skips number 39 while text remains continuous** | **legacy 110 bilingual records preserved under `volume-1`; canonical English migration/alignment blocked pending completion of the second Tamil fidelity gate** |
