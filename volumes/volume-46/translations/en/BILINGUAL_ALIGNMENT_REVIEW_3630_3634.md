# Volume 46 — Bilingual Alignment Review: 3630–3634

## Scope

Five-letter Batch 8, covering **PDF 296–328**:

- 3630 — `விரிக்கிற பெருகும்; விரிஞ்சி விடுகிறேன்!`
- 3631 — `ஜனநாயகம் கேலிப் பொருளாகி விடுவதா?`
...
- D. Pandian/Pudukkottai opening preserved.
- 2008–09 Eelam chronology, quoted statements, dates, party references and relief figures preserved in source order.
...
- Source-mixed title `OTHERWISE - ஜனாதிபதி` preserved.
- Article 356 / `Otherwise` argument and 1990–91 chronology preserved.
- R. Venkataraman, Barnala, V.P. Singh and Jayalalithaa passages retain source framing.
- Former-President characterisations and Pratibha Patil criticism remain source-attributed rather than externally normalised.
- Source closing without a comma after `அன்புள்ள` remains preserved in the Tamil appendix.

### 3633 — PASS

- Pudukkottai by-election argument preserved.
- `இடைத்` / `எடை` / `நடை` wordplay remains represented explicitly.
- Earlier by-election comparisons, vote figures and deposit point preserved.
- Ennore, Mettur, North Chennai and Udangudi project dates/costs/capacities and 7,798 MW total preserved.
- Complete Tamil appendix present.

### 3634 — PASS

- Actual semicolon heading controls over the differing contents-page comma form.
- Veerapandi Arumugam chronology, statutory section counts, Goondas Act references and court observations preserved.
- K.P.P. Samy, Kalaivanan, J. Anbazhagan and other case narratives retain source order and rhetorical force.
- The long source-printed arrest-name sequence is reproduced rather than compressed.
- Paranjothi charge-sheet chronology and the concluding emergency Executive Committee call align.
- Complete Tamil appendix present.
